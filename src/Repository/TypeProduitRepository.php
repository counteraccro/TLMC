...
class TypeProduitRepository extends ServiceEntityRepository
{
    ...
    /**
     * Retourne une liste de type de produit paginé en fonction de l'ordre et de la recherche courante
     *
     * @param int $page
     * @param int $max
     * @param array $params
     ...
     */
    public function findAllTypeProduits(int $page = 1, int $max = 10, $params = array())
    {
        if (! is_numeric($page)) {
        ...
        // Nombre total de types de produit
