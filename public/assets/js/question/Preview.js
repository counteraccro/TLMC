...
Preview.Launch = function(params) {
	...
	Preview.subRepeatEvent = function()
	{
		...
		// permet de renvoyer en preview le message d'erreur (case à cocher pour visualiser)
		$(Preview.id_global +  ' #checkbox_msg_erreur').click(function() {
			var checkBox = document.getElementById("checkbox_msg_erreur");

			// If the checkbox is checked, display the output text
			if (checkBox.checked == true){
				checkbox_message_erreur.style.display = "block";
			} else {
				checkbox_message_erreur.style.display = "none";
			}
		});
	}
